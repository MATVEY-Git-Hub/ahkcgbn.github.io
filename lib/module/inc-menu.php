...
<div class='menu-con-container'>
	...
	<div class="menu-con-outer">
		<div class="menu-con-inner">
			...
			<a href='https://vk.com/cgbn.province1'>
			<div class="menu-btn-select">
				<span>Группа ЦГБ-Н</span>
			</div>
			</a>
			<div class="menu-con-divider">
			</div>
			<a href='https://vk.com/gos.frakcii01' target="_blank">
			<div class="menu-btn-select">
				<span>Группа Новости фракций</span>
			</div>
			</a>
			<div class="support-con-menu">
				<a href="https://vk.com/ahk.manager" target="_blank">
